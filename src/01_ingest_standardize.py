...
from config import (get_db_connection, initialize_database, CURRENCY_RATES, 
                   convert_to_usd, log_audit, print_header)
...
class DataIngestionPipeline:
    ...
    def ingest_fund_master_csv(self):
        ...
        try:
            # Load CSV
            df = pd.read_csv('../data/input/fund_master.csv')
    ...
    def ingest_performance_json(self):
        ...
        try:
            # Load JSON
            with open('../data/input/fund_performance.json', 'r') as f:
                data = json.load(f)
    ...
    def ingest_regulatory_json(self):
        ...
        try:
            # Load JSON
            with open('../data/input/regulatory_filings.json', 'r') as f:
                data = json.load(f)
